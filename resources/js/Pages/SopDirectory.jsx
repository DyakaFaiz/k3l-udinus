                    ...
                    {paginatedSops.length > 0 ? (
                        paginatedSops.map(sop => (
                            <div key={sop.id} className="sop-card">
                                ...
                                <a href={`/files/panduan-k3l/${sop.filename}.pdf`} target="_blank" rel="noopener noreferrer" style={{ display: 'inline-block', marginTop: '1rem', background: 'transparent', color: 'var(--secondary)', fontWeight: 'bold', fontSize: '0.95rem', textDecoration: 'none' }}>
                                    Baca Dokumen ➔
                                </a>
                            </div>
                        ))
